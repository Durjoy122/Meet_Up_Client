        ...
        <div className="drawer lg:drawer-open max-w-7xl mx-auto ">
            ...
            <div className="drawer-content">
                ...
                <nav className="navbar w-full bg-base-300">
                    ...
                    <div className="px-4">MeetUp Dashboard</div>
                </nav>
                {/* Page content here */}
                <Outlet></Outlet>
                    ...
                    <ul className="menu w-full grow">
...

                        {
                            role === 'admin' && <>
                                ...
                                <li>
                                    <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Club Management" to="/dashboard/club-management">
                                        <GiCard10Clubs />
